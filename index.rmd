...
-- R, SAS, Python, MATLAB, LaTeX, SQL, STATA, C++ <br>
...
## Education <br>
**Doctor of Philosophy, Biostatistics**   Exp 2023 <br>
...
**Summer Intern** Jun - Aug 2022 <br>
*Graduate Data Science Summer Internship Program, National Institutes of Health* <br>
-- Preprocessing experimental neural data for a recurrent spiking network model <br>
-- Utilizing the high performance computing environment in linux provided by the NIH to run the GPU based model algorithm 

**Academic Coach** Feb - Apr 2022 <br>
*University of Cincinnati Accessibility Resources* <br>
-- Meet with students who need academic help <br>
-- Assisted in developing students executive functioning skills <br>
...
-- Working under Rhonda Szczeniak Ph.D. and Judith Dexheimer Ph.D. on a Cystic Fibrosis project to predict for an outcome comparing machine learning methods to the statistical approach <br>
-- Used Tensorflow & Keras python packages to develop neural network code <br>
-- Developed algorithms to pre-process the big data <br>
-- Worked specifically with recurrent neural networks and imbalanced repeated measures data <br>
...
**National Liaison for the Union of Concerned Scientists**   May 2021 - 2022 <br>
...
-- Applied Multivariate Analysis <br>
-- Biostatistics in Research <br>
